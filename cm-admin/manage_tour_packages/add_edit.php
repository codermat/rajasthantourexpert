						 ...
						 <div class="control-group">
								...
								<div class="controls">
								  <select id="in_footer" name="in_footer" data-rel="chosen">
								   <?php if(isset($datainfo->in_footer)) { ?>								   
									<option value="t" <?php if($datainfo->in_footer=='t') { echo "selected"; } ?>>Yes</option>
									<option value="f" <?php if($datainfo->in_footer=='f') { echo "selected"; } ?>>No</option>
									 <?php }else { ?>
