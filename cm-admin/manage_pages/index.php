			...
			<div class="row-fluid sortable">		
				...
				{?>  
							...
							<td><?php echo $record->id;?></td>
								...
								<td><a href="<?php echo $function->get_seo_url($record->seo_url);?>" target="_blank"><?php echo $record->title;?></a></td>
								<td><a href="<?php echo $function->get_seo_url($record->seo_url);?>" target="_blank"><?php echo $function->get_seo_url($record->seo_url);?></a></td>
								<td class="center">
								...
								<td class="center">
									...
									<a  style="display:none;"class="btn btn-danger" href="javascript:void();" onClick="delete_record(<?php echo $record->id;?>);" >
