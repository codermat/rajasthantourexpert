						...
						<?php } ?>
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="author" required class="span7 typeahead" value="<?php if(isset($datainfo->author)) { echo $datainfo->author; } ?>" id="author" >
							...
							<div class="control-group">
							  <label class="control-label" for="typeahead">Testimonials Desc.</label>
							  <div class="controls">
								<textarea name="testimonials_desc" rows="10" class="cleditor span7"  id="testimonials_desc" ><?php  if(isset($datainfo->testimonials_desc)) {  echo $datainfo->testimonials_desc; } ?></textarea>
