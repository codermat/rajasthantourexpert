...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2018 at 05:07 PM
...
--
-- Table structure for table `cm_blog`
--
...
--
-- Dumping data for table `cm_blog`
--

INSERT INTO `cm_blog` (`id`, `title`, `sub_title`, `meta_title`, `seo_url`, `meta_tag_keywords`, `meta_tag_descriptions`, `short_desc`, `desc`, `featured_image`, `other_images`, `sortorder`, `is_featured`, `in_footer`, `status`, `dateadded`) VALUES
(1, 'South India Tour Blog', 'South India Tour Blog H', 'South India Tour Blog  Meta Title', 'south-india-tour-blog', 'dfds', 'sdfd', '<p>&nbsp;Iti is first blog post short desc</p>', '<p>Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog po</p>\r\n<p>st short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc   Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog p</p>\r\n<p>ost short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc Iti is first blog post short desc</p>', 'http://localhost/rajasthantourexpert/uploads/09-18/1537893935_destination2.jpg', 'N;', 0, '', '', 't', 1537893970),
(2, 'South India Tour', 'About Rajasthan Tour Expert', 'dfgdf', 'south-india-tour', 'gdf', 'dfgfd', '<p>&nbsp;dfgfdg</p>', '<p>&nbsp;dfgfd</p>', 'http://localhost/rajasthantourexpert/uploads/09-18/1537895011_destination3.jpg', 'N;', 0, '', '', 't', 1537895016);
...
INSERT INTO `cm_destinations` (`id`, `title`, `sub_title`, `meta_title`, `seo_url`, `meta_tag_keywords`, `meta_tag_descriptions`, `short_desc`, `desc`, `featured_image`, `other_images`, `sortorder`, `is_featured`, `in_footer`, `status`, `dateadded`) VALUES
(1, 'Jaipur 1', 'About Jaipur', '', 'jaipur-1', 'Jaipur keywords 2', 'Jaipur tag desc 3', '<p>Jaipur, popularly known as the &quot;Pink City&quot;, and &quot;Paris of India&quot;, is the capital of Rajasthan state.</p>\r\n<p>&nbsp;</p>', '<p>&nbsp;Hello from desc</p>', 'http://localhost/rajasthantourexpert/uploads/08-18/1535184900_destination1.jpg', 'a:10:{i:0;s:75:"http://localhost/rajasthantourexpert/uploads/08-18/1535185177_gallery01.jpg";i:1;s:75:"http://localhost/rajasthantourexpert/uploads/08-18/1535185182_gallery02.jpg";i:2;s:0:"";i:3;s:0:"";i:4;s:0:"";i:5;s:0:"";i:6;s:0:"";i:7;s:0:"";i:8;s:0:"";i:9;s:0:"";}', 0, 't', 't', 't', 1535185191);
...
INSERT INTO `cm_pages` (`id`, `title`, `sub_title`, `meta_title`, `pagetype`, `seo_url`, `meta_tag_keywords`, `meta_tag_descriptions`, `featured_image`, `short_desc`, `desc`, `status`) VALUES
(1, 'About Us', 'About Rajasthan Tour Expert', '', 'left-sidebar', 'about-us', 'About Us', 'About Us', 'http://localhost/rajasthantourexpert/uploads/08-18/1533717686_header1.jpg', '<p>Govinda aala re aala</p>', '<p>&nbsp;desc</p>', 't'),
...
CREATE TABLE IF NOT EXISTS `cm_tours` (
  ...
  `start_destination` int(11) NOT NULL,
  `title` varchar(500) NOT NULL,
  `meta_title` varchar(500) NOT NULL,
  `seo_url` varchar(500) NOT NULL,
  `meta_tag_keywords` varchar(500) NOT NULL,
...
INSERT INTO `cm_tours` (`id`, `tourpackageid`, `start_destination`, `title`, `meta_title`, `seo_url`, `meta_tag_keywords`, `meta_tag_descriptions`, `duration`, `destination`, `short_desc`, `desc`, `tour_map`, `featured_image`, `other_images`, `sortorder`, `is_parent`, `status`, `dateadded`) VALUES
...
INSERT INTO `cm_tour_packages` (`id`, `pcatid`, `title`, `meta_title`, `seo_url`, `meta_tag_keywords`, `meta_tag_descriptions`, `short_desc`, `desc`, `featured_image`, `sortorder`, `is_parent`, `in_footer`, `status`, `dateadded`) VALUES
...
(2, 0, 'Same Day Tours', 'Meta Title of Same Day Tours', 'same-day-tours', 'Same Day Tours', 'Same Day Tours', '<p>&nbsp;Same Day Tours</p>', '', '', 0, 'f', 't', 't', 1537435544);
